...
<!-- content-Buttons -->
    <div class="button-container">
        <a href="#" class="button button-find-dog">
          Find a <br> Dog
          <img src="../icons/btn-dog.png" alt="Dog Icon" class="dog-icon">
        </a>
        <a href="#" class="button button-find-cat">
          Find a <br>Cat
...
<h2 id="available-pet">Available Dogs For Adaption</h2>

<div class="pet-container">
        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/cheese.jpg" alt="Pet 1">
            </a>
            <div class="pet-name">Brutus</div>
        </div>

        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/cheese.jpg" alt="Pet 2">
            </a>
            <div class="pet-name">Boi</div>
        </div>

        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/cheese.jpg" alt="Pet 3">
            </a>
            <div class="pet-name">Stacy</div>
        </div>

        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/cheese.jpg" alt="Pet 4">
            </a>
            <div class="pet-name">Cheese</div>
        </div>
    </div>
...
<div class="pet-container">
        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/eren.jpg" alt="Pet 1">
            </a>
            <div class="pet-name">Eren</div>
        </div>

        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/eren.jpg" alt="Pet 2">
            </a>
            <div class="pet-name">Yeager</div>
        </div>

        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/eren.jpg" alt="Pet 3">
            </a>
            <div class="pet-name">Cali</div>
        </div>

        <div class="pet-card">
            <a href="#">
                <img class="pet-image" src="../icons/eren.jpg" alt="Pet 4">
            </a>
            <div class="pet-name">Doja</div>
        </div>
    </div>
